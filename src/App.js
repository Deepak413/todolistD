...
const App = () => {
  ...
  const [inputList, setInputList] = useState("");   //bydefault declaring a variable to store the input value

  const [Items, setItems] = useState([]);      //bydefault declaring an array to store all the inputs
